...
public class Transcoder {
	...
	public static String CreatJob(String key) {
		...
		String jobid2 = completeJobStatus(jobId);
		
		return "out_" + key;
	}
	
	public static String completeJobStatus(String jobId) {
